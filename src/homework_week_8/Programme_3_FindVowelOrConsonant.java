...
public class Programme_3_FindVowelOrConsonant {
    public static void checkVowelOrConsonent(String letter) {
        ...
        if (letter.length() > 1) {
            ...
            System.out.println("Error . Not  a letter. Enter uupercase or lowercase letter ");
    ...
    public static void main(String[] args) {
        // Scanner declaretion for reading input form console
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter any character : ");
        String str = scanner.next().toLowerCase();
        // calling static method directly
        checkVowelOrConsonent(str);
